<x-admin-layout>
    <div class="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md">
        <h1 class="text-2xl text-gray-900 dark:text-white font-bold">Tambah Hutang Baru</h1>
        <br>
        <form action="{{ route('admin.payable.store') }}" method="POST" id="payable-form">
            @csrf
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" id="lender_name" name="lender_name" value="{{ old('lender_name') }}"
        ...
        <x-confirm-create-update-button :name="'confirm-create'" modalForm="payable-form"
            confirmMessage="Konfirmasi Pembuatan Data Hutang"
            question="Apakah kamu yakin ingin menambah data hutang ini?" buttonText="Ya, Buat" />
    </div>
</x-admin-layout>
