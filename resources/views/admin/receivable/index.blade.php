<x-admin-layout>
    ...
    <div class="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md">
        ...
        <div class="hidden md:block">
            <x-filter-add-table :action="route('admin.receivable.index')" :route="route('admin.finance.index')" searchPlaceholder="Cari nama pelanggan..."
                selectName="status" :selectOptions="['paid' => 'Lunas', 'unpaid' => 'Belum Lunas', 'partial' => 'Cicil']" selectLabel="Semua status" />
