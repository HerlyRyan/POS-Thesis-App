<x-admin-layout>
    ...
    <div class="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md">
        ...
        <div class="hidden md:block">
            <x-filter-add-table :action="route('admin.trucks.index')" :route="route('admin.trucks.create')"
                searchPlaceholder="Cari nomor plat..." selectName="status" :selectOptions="['tersedia' => 'Tersedia', 'dipakai' => 'Dipakai', 'diperbaiki' => 'Diperbaiki']"
                selectLabel="Semua status" textAdd="Truk" />
