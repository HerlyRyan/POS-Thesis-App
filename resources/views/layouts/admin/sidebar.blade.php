    ...
    <nav class="mt-10">
        ...
        <div class="relative group">
            <button id="dropdown-button-master"
                class="flex items-center px-6 py-2 mt-4 {{ Route::currentRouteNamed('admin.product.*') || Route::currentRouteNamed('admin.customers.*') || Route::currentRouteNamed('admin.employees.*') ? 'text-gray-100' : 'text-gray-500' }} hover:bg-gray-700 hover:bg-opacity-25 hover:text-gray-100">
                <svg class="h-6 w-6" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                    stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        d="M4 7v10c0 2 1 3 3 3h10c2 0 3-1 3-3V7c0-2-1-3-3-3H7c-2 0-3 1-3 3z" />
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 17v-6m3 6v-4m3 4v-2" />
                </svg>
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        const isMasterActive = {{ 
            ...
            Route::currentRouteNamed('admin.trucks.*') ? 'true' : 'false' 
        }};
        ...
        const isReportActive = {{ 
            ...
            Route::currentRouteNamed('admin.report_low_stock.*') ? 'true' : 'false' 
        }};
        
        const isConfigActive = {{ 
            Route::currentRouteNamed('admin.users.index') || 
            Route::currentRouteNamed('admin.roles.index') || 
            Route::currentRouteNamed('admin.permissions.index') ? 'true' : 'false' 
        }};
